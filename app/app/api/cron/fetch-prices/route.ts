...
// Vercel Cron: calls fetch-prices Edge Function every 10 minutes (16-19 UTC, Mon-Fri).
...
export async function GET(request: NextRequest) {
  ...
  const efUrl = `${process.env.NEXT_PUBLIC_SUPABASE_URL}/functions/v1/fetch-prices`;
