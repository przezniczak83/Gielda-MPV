// GET /api/cron/fetch-espi
// Vercel Cron: calls fetch-espi Edge Function every 10 minutes.
...
export async function GET(request: NextRequest) {
  ...
  const efUrl = `${process.env.NEXT_PUBLIC_SUPABASE_URL}/functions/v1/fetch-espi`;
